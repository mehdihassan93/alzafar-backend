...
export class CartsController {
  ...
  async moveItem(
    ...
    return this.cartsService.moveItem(
      req.user.userId,
      fromCartId,
      toCartId,
      productId,
  ...
  @Get(':id/validate')
  @ApiOperation({
    summary: 'Check for issues in a cart (out of stock, discontinued, etc.)',
  })
  ...
  @Post('merge')
  @ApiOperation({
    summary: 'Merge a local cart into the users account upon login',
  })
