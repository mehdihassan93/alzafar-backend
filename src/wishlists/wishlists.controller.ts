...
export class WishlistsController {
    ...
    async addItem(
        ...
        return this.wishlistsService.addItem(req.user.userId, wishlistId, productId);
    }
    ...
    async removeItem(
        ...
        return this.wishlistsService.removeItem(req.user.userId, wishlistId, productId);
    }
    ...
    async toCart(
        ...
        return this.wishlistsService.moveToCart(req.user.userId, wishlistId, productId, cartId);
    }
    ...
    async moveItem(
        ...
        return this.wishlistsService.moveItemBetweenWishlists(req.user.userId, fromId, toId, productId);
    }
